...
#define PTE_ADDR(pageentry)     ((uintptr_t) (pageentry) & ~0xFFFUL) // dispose of the last 12 bits

// Page table entry flags
#define PTE_FLAGS(pageentry)    ((x86_64_pageentry_t) (pageentry) & 0xFFFU) // keep the last 12 bits
